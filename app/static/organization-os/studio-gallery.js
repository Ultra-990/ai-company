...
(() => {
 ...
 stage.addEventListener('wheel',event=>{if(event.ctrlKey||!dialog.open)return;event.preventDefault();if(phase==='open')setZoom(zoom+(event.deltaY<0?.1:-.1));},{passive:false});
